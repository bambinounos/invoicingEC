...
public function barcode( $filepath, $text, $size="40", $orientation="horizontal", $code_type="code25", $print=true, $SizeFactor=1 ) {
	$code_string = "";
	...
	if ( $print ) {
		imagestring($image, 5, 18, $img_height, $text, $black );
	}

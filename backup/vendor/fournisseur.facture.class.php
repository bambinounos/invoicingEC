...
class FactureFournisseur extends CommonInvoice
{
	...
	public function fetch($id = '', $ref = '', $ref_ext = '')
	{
		...
		$sql .= " t.import_key,";
		$sql .= " t.extraparams,";
		$sql.= " t.f_note1, t.f_note2, t.f_note3, t.f_note4, t.f_note5,t.f_note6, t.f_note7, t.f_name1, t.f_name2, t.f_name3, t.f_name4, t.f_name5,t.f_name6, t.f_name7,t.invoice_number,t.identification_type, t.tip, t.reason_type, t.warehouse, t.seller, t.ws_time, t.claveacceso, t.ws_time_end, t.claveacceso_end, t.date_done, t.date_create, t.ws_approval_one, t.ws_approval_two, t.ws_approval_thr, t.ws_approval_fou,  ";
		...
		if ($resql) {
			if ($this->db->num_rows($resql)) {
				...
				$this->tip					= $obj->tip;
				$this->f_note1				= $obj->f_note1;
				$this->f_note2				= $obj->f_note2;
				$this->f_note3				= $obj->f_note3;
				$this->f_note4				= $obj->f_note4;
				$this->f_note5				= $obj->f_note5;
				$this->f_note6				= $obj->f_note6;
				$this->f_note7				= $obj->f_note7;
				$this->f_name1				= $obj->f_name1;
				$this->f_name2				= $obj->f_name2;
				$this->f_name3				= $obj->f_name3;
				$this->f_name4				= $obj->f_name4;
				$this->f_name5				= $obj->f_name5;
				$this->f_name6				= $obj->f_name6;
				$this->f_name7				= $obj->f_name7;
				...
				$this->ws_approval_one			= $obj->ws_approval_one;
				$this->ws_approval_thr			= $obj->ws_approval_thr;
				$this->ws_approval_two			= $obj->ws_approval_two;
				$this->ws_approval_fou			= $obj->ws_approval_fou;				

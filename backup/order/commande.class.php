...
class Commande extends CommonOrder
{
	...
	public function create($user, $notrigger = 0)
	{
		...
		$sql .= "', '" . $this->c_name7;
		$sql .= "', '" . $this->c_note7;
		$sql .= "', " . $this->identification_type;
		$sql .= ", " . $this->identification_c_type;
		$sql .= ")";
	...
	public function fetch($id, $ref = '', $ref_ext = '', $notused = '')
	{
		...
		$sql .= ', c.fk_account, c.carrier, c.c_note1, c.c_note2, c.c_note3, c.c_note4, c.c_note5, c.c_note6, c.c_note7, c.c_name1, c.c_name2, c.c_name3, c.c_name4, c.c_name5, c.c_name6, c.c_name7,c.invoice_number, c.identification_type, c.identification_c_type, c.tip, c.reason_type, c.warehouse, c.seller,c.start_date,c.end_date ';
		$sql .= ', c.date_commande, c.date_valid, c.tms, c.ws_time, c.claveacceso, c.ws_time_end, c.claveacceso_end';

...
/**
 * \file    approval/admin/setup.php
 * \ingroup approval
 * \brief   Approval setup page.
 */
require '../../../main.inc.php';
require_once DOL_DOCUMENT_ROOT.'/core/lib/admin.lib.php';
require_once DOL_DOCUMENT_ROOT.'/core/lib/files.lib.php';
$langs->loadLangs(array('admin', 'approval', 'orders', 'sendings', 'companies', 'bills', 'propal', 'supplier_proposal', 'deliveries', 'products', 'stocks', 'productbatch'));
llxHeader('', $langs->trans("Subir archivo PEM"));
print load_fiche_titre($langs->trans("Subir archivo PEM"), '', 'tools');
$result = restrictedArea($user, 'fournisseur', $id, 'commande_fournisseur', 'commande');


	print '<div class="centpercent table-fiche-title ">';
	print '<form action="post.php" method="post" enctype="multipart/form-data">';
	print '<input type="hidden" name="token" value="' . newToken() . '">';
	print '<table class="noborder centpercent">';
	print '<tr><td>';
	print '&nbsp;&nbsp;Key.pem Archivo&nbsp;&nbsp;';
	print '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" class="flat" id="keyfile" name="keyfile"/>';
	print '</td></tr><tr><td>&nbsp;&nbsp;Cert.pem Archivo&nbsp;&nbsp;';
	print '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" class="flat" id="certfile" name="certfile"/>';
	print '<input type="submit" class="button valignmiddle" value="' . $langs->trans("Send") . '"></td></tr></table>';
	print '</td></tr></table>';
	print "</form>";
	print '</div>';
...
// // Libraries
// require_once DOL_DOCUMENT_ROOT."/core/lib/admin.lib.php";
// // require_once '../lib/approval.lib.php';
// //require_once "../class/myclass.class.php";

// // Translations
// $langs->loadLangs(array("admin", "approval@approval"));
...
// 	'APPROVAL_MYPARAM1'=>array('type'=>'string', 'css'=>'minwidth500' ,'enabled'=>1),
// 	'APPROVAL_MYPARAM2'=>array('type'=>'textarea','enabled'=>1),
// 	//'APPROVAL_MYPARAM3'=>array('type'=>'category:'.Categorie::TYPE_CUSTOMER, 'enabled'=>1),
// 	//'APPROVAL_MYPARAM4'=>array('type'=>'emailtemplate:thirdparty', 'enabled'=>1),
// 	//'APPROVAL_MYPARAM5'=>array('type'=>'yesno', 'enabled'=>1),
// 	//'APPROVAL_MYPARAM5'=>array('type'=>'thirdparty_type', 'enabled'=>1),
// 	//'APPROVAL_MYPARAM6'=>array('type'=>'securekey', 'enabled'=>1),
// 	//'APPROVAL_MYPARAM7'=>array('type'=>'product', 'enabled'=>1),
// );
...
// 		$file = dol_buildpath($reldir."core/modules/approval/doc/pdf_".$modele."_".strtolower($tmpobjectkey).".modules.php", 0);
// 		if (file_exists($file)) {
// 			$filefound = 1;
...
// 		$constforval = 'APPROVAL_'.strtoupper($tmpobjectkey)."_ADDON";
...
// 		$tmpobjectkey = GETPOST('object');
// 		if (!empty($tmpobjectkey)) {
// 			$constforval = 'APPROVAL_'.strtoupper($tmpobjectkey).'_ADDON_PDF';
...
// // $head = approvalAdminPrepareHead();
// print dol_get_fiche_head($head, 'settings', $langs->trans($page_name), -1, "approval@approval");

// // Setup page goes here
// echo '<span class="opacitymedium">'.$langs->trans("ApprovalSetupPage").'</span><br><br>';
...
// 								$constforvar = 'APPROVAL_'.strtoupper($myTmpObjectKey).'_ADDON';

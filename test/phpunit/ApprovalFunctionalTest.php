...
/**
 * \file    test/phpunit/ApprovalFunctionalTest.php
 * \ingroup approval
 ...
 *
 * @package Testapproval
 */
class ApprovalFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 20230815; // TODO: autodetect?
	...
	{
		$this->url('/custom/approval/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('approval/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/approval/admin/about.php');
		$this->authenticate();
		return $this->assertContains('approval/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('approvalwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modApproval_ApprovalTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modApproval_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
